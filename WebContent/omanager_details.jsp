    ...
    <nav id="mainav" class="fl_right"> 
      ...
      <ul class="clear">
        <li ><a href="adminhome.jsp">Employee details</a></li>
         ...
         <li class="active"><a href="omanager_details.jsp">Office Manager</a></li>
        <li ><a href="generate_payslip.jsp" >Generate Payslip</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">Office Manager Details</h6>
    </div>
   <div class="contact">
		<div class="container">
  ...
  <%
    ...
    String sql="select * from office_manager";
    ...
    while(rs.next())
     ...
     %>
        ...
        <td data-title="Studio"><%=rs.getString("phone") %></td>
        <td data-title="Studio"><%=rs.getString("location") %></td>
        <td data-title="Studio"><%=rs.getString("status") %></td>
        <td data-title="Studio"><a href="omanager_accept.jsp?unid=<%=rs.getString("id")%>&&email=<%=rs.getString("email")%>">Accept Office Manager Request</a></td>
