...
<div class="bgded overlay padtop" style="background-image:url('images/demo/backgrounds/01.jpg');"> 
  ...
  <header id="header" class="hoc clear">
    ...
    <nav id="mainav" class="fl_right"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li ><a href="adminhome.jsp">Employee details</a></li>
         <li ><a href="pmanager_details.jsp">Production Manager</a></li>
       
         <li ><a href="omanager_details.jsp">Office Manager</a></li>
        <li class="active"><a href="generate_payslip.jsp" >Generate Payslip</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">Product Purchase Payment Details</h6>
    </div>
   <div class="contact">
		<div class="container">
  ...
  <%
    ...
    while(rs.next())
     ...
     %>
        ...
        <td data-title="Studio"><%=rs.getString("date") %></td>
        
        <td data-title="Studio"><a href="generate_payslip1.jsp?pname=<%=rs.getString("parts_name")%>&&quantity=<%=rs.getString("quantity")%>&&amount=<%=rs.getString("amount")%>&&date=<%=rs.getString("date")%>">Generate Payslip</a></td>
