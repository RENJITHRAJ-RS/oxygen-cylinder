    ...
    <nav id="mainav" class="fl_right"> 
      ...
      <ul class="clear">
        <li class="active"><a href="ownerhome.jsp">View Product Parts Request</a></li>
         <li ><a href="view_graph.jsp">View Graph</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">View Product Parts Request</h6>
    </div>
    <div class="contact">
		<div class="container">
    ...
    while(rs.next())
     ...
     %>
        ...
        <td data-title="Studio"><%=rs.getString("owner_status") %></td>
            <td data-title="Studio"><a href="approveto_buy.jsp?unid=<%=rs.getString("id")%>">Apply To Buy</a></td>
