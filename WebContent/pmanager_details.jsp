      ...
      <!-- ################################################################################################ -->
       <ul class="clear">
        <li ><a href="adminhome.jsp">Employee details</a></li>
         <li class="active"><a href="pmanager_details.jsp">Production Manager</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">Production Manager Details</h6>
    </div>
    <div class="contact">
		<div class="container">
  ...
  <%
    ...
    while(rs.next())
     ...
     %>
        ...
        <td data-title="Studio"><a href="pmanager_accept.jsp?unid=<%=rs.getString("id")%>&&email=<%=rs.getString("email")%>">Accept Employee</a></td>
