    ...
    <nav id="mainav" class="fl_right"> 
      <!-- ################################################################################################ -->
       <ul class="clear">
        ...
        <li class="active"><a href="purchase_parts.jsp" >Purchase parts</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">Send Request To Office Manager For To purchase Parts</h6>
    </div>
    ...
    <div class="contact">
		<div class="container">
			...
			<div class="contact-mian">
				...
				<form action="parts_requestdb.jsp" method="post">
				<table style="width:400px;height:200px;">
				<tr>
				<td>
				<label style="align:left;">Product Parts Name</label>
				</td>
				<td><input type="text" name="parts_name" style="width:250px;align:justify;color:black;"></td>
				</tr>
				
				<tr>
				<td><label style="align:left;">Quantity</label></td>
				<td><input type="text" name="quantity" style="width:250px;align:justify;color:black;"></td>
				</tr>
				...
				<div class="col-md-4 contact-left">
					<img src="images/images/request1.png" width="150" height="250">
