...
session.setAttribute("pid2", pid1);
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">Upload Solution</h6>
    </div>
    ...
    <div class="contact">
		<div class="container">
			...
			<form method="post" action="solution_senddb.jsp" style="margin-left:300px;">
				<table style="width:400px;height:200px;">
				<tr>
				<td>
				<label style="align:left;margin-top:105px;margin-left:6px;font-weight:600;">Solution:</label>
				</td>
				<td>
			<textarea name="solution1" rows="10" cols="20" style="text-align:left;">
			</textarea>
				</td>
				</tr>
