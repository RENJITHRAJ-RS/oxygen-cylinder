...
<div class="bgded overlay padtop" style="background-image:url('images/demo/backgrounds/01.jpg');"> 
  ...
  <header id="header" class="hoc clear">
    ...
    <nav id="mainav" class="fl_right"> 
      <!-- ################################################################################################ -->
       <ul class="clear">
        <li class="active"><a href="ownerhome.jsp">View Product Parts Request</a></li>
         <li ><a href="pmanager_details.jsp">View Graph</a></li>
   ...
   <div class="contact">
		<div class="container">
			<div class="contact-top">
				<h3>Send Request To Office Manager For To purchase Parts</h3>
			</div>
    ...
    String sql="select * from parts_purchase where id='"+unid+"'";
    ...
    while(rs.next())
     {%>
				...
				<tr>
				<td>
				<label style="align:left;">Product Parts Name</label>
				</td>
				<td><input type="text" name="parts_name" value="<%=rs.getString("parts_name")%>"style="width:250px;align:justify;color:black;"></td>
				</tr>
				
				<tr>
				<td><label style="align:left;">Quantity</label></td>
				<td><input type="text" name="quantity" value="<%=rs.getString("quantity")%>"style="width:250px;align:justify;color:black;"></td>
				</tr>
				<tr>
				<td><label style="align:left;">Amount</label></td>
				<td><input type="text" name="amount" style="width:250px;align:justify;color:black;"></td>
				</tr>
				
				<tr>
				<td><label style="align:left;">Date</label></td>
				<td><input type="text" name="date" value="<%=strDateNew%>"style="width:250px;align:justify;color:black;"></td>
				</tr>
				</table>
    ...
    %>
				...
				<div class="col-md-4 contact-left">
					<img src="images/request1.png" width="250" height="250">
