...
<div class="bgded overlay padtop" style="background-image:url('images/demo/backgrounds/01.jpg');"> 
  ...
  <header id="header" class="hoc clear">
    ...
    <nav id="mainav" class="fl_right"> 
      <!-- ################################################################################################ -->
       <ul class="clear">
        <li ><a href="employee_home.jsp">View Cylinder</a></li>
         <li class="active"><a href="view_defection.jsp">View Defection</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">View Product Defection</h6>
    </div>
    <div class="contact">
		<div class="container">
    ...
    while(rs.next())
     ...
     %>
        ...
        <td data-title="Studio"><%=rs.getString("refilling_defect") %></td>
           <td data-title="Studio"><a href="solution_sendemployee.jsp?pid=<%=rs.getString("id")%>&&email1=<%=rs.getString("emp_email")%>">Send Solution To employee</a></td>
