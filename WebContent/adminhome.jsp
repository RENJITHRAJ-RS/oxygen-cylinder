...
<div class="bgded overlay padtop" style="background-image:url('images/demo/backgrounds/01.jpg');"> 
  ...
  <header id="header" class="hoc clear">
    ...
    <nav id="mainav" class="fl_right"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li class="active"><a href="adminhome.jsp">Employee details</a></li>
  ...
  <%
    ...
    while(rs.next())
     ...
     %>
        ...
        <td data-title="Studio"><a href="employee_accept.jsp?unid=<%=rs.getString("id")%>&&email=<%=rs.getString("email")%>">Accept Employee</a></td>
