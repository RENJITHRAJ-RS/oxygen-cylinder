...
<div class="bgded overlay padtop" style="background-image:url('images/demo/backgrounds/01.jpg');"> 
  ...
  <header id="header" class="hoc clear">
    ...
    <nav id="mainav" class="fl_right"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li class="active"><a href="officermanager_home.jsp">View Employee Request</a></li>
         <li ><a href="owner_response.jsp">View Owner Response</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">View Employee Request</h6>
    </div>
   <div class="contact">
		<div class="container">
  ...
  <%
    ...
    String sql="select * from parts_purchase where pmanager_status='"+status+"'";
    ...
    while(rs.next())
     ...
     %>
        ...
        <td data-title="Studio"><%=rs.getString("pmanager_status") %></td>
            <td data-title="Studio"><a href="applyto_buy.jsp?unid=<%=rs.getString("id")%>">Apply To Buy</a></td>
