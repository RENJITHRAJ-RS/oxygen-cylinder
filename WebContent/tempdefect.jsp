...
int temp11=Integer.parseInt(temp1);
 if(temp11<=80)
 {
	 ...
	 String sql="update upload_cylinder set temp_defect='"+pstatus+"' where id='"+pid+"'";
 ...
 else
 {
	 ...
	 String sql1="update upload_cylinder set temp_defect='"+pstatus1+"' where id='"+pid+"'";
	 ...
	 %>
	 <script>
	 alert("No Temperature Defect In Product");
	 window.location="productionmanager_home.jsp";
	 </script>
	 <% 
	 }
