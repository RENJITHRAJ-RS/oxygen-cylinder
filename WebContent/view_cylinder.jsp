      ...
      <!-- ################################################################################################ -->
       <ul class="clear">
        <li ><a href="employee_home.jsp">Upload Cylinder</a></li>
         <li class="active"><a href="view_cylinder.jsp">View Cylinder</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">Employee Details</h6>
    </div>
    <div class="contact">
		<div class="container">
			<div class="contact-top">
				<h3>View Cylinder Details</h3>
			</div>
  ...
  <%
    ...
    String sql="select * from upload_cylinder";
    ...
    while(rs.next())
     ...
     %>
    	<tr>
        <td scope="row"><%=rs.getString("oxygen_type") %></td>
        <td data-title="Released"><%=rs.getString("temperature") %></td>
        <td data-title="Studio"><%=rs.getString("pressure") %></td>
        <td data-title="Studio"><%=rs.getString("tube_material") %></td>
        <td data-title="Studio"><%=rs.getString("cylinder_type") %></td>
         <td data-title="Studio"><%=rs.getString("gas_type") %></td>
          <td data-title="Studio"><%=rs.getString("gas_capacity") %></td>
           <td data-title="Studio"><%=rs.getString("expiring_date") %></td>
           <td data-title="Studio"><%=rs.getString("refilling_date") %></td>
             <td data-title="Studio"><img src="viewimage.jsp?id=<%=rs.getString("id")%>" width="130" height="120" alt="" class="userpic" /></td>
        <td data-title="Studio"><a href="view_defects.jsp?unid=<%=rs.getString("id")%>&&temperature=<%=rs.getString("temperature")%>&&pressure=<%=rs.getString("pressure")%>&&gas_capacity=<%=rs.getString("gas_capacity")%>&&expiring_date=<%=rs.getString("expiring_date")%>&&refilling_date=<%=rs.getString("refilling_date")%>">View Defects</a></td>
