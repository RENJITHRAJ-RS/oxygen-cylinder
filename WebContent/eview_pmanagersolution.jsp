      ...
      <!-- ################################################################################################ -->
       <ul class="clear">
        <li ><a href="employee_home.jsp">Upload Cylinder</a></li>
         ...
         <li  class="active"><a href="eview_pmanagersolution.jsp">Production Manager Solution</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
    ...
    <div class="contact">
		<div class="container">
			<div class="contact-top">
				<h3>View Production Manager Solution</h3>
			</div>
  ...
  <tr>
    <th>Id</th>
    <th>Temperature Defect</th>
    <th>Pressure Defect</th>
    
       <th>Gas Capacity Defect</th>
        <th>Expiring Date Defect</th>
        <th>Refilling Date Defect</th>
  ...
  <%
    ...
    while(rs.next())
     ...
     %>
        ...
        <td scope="row"><%=rs.getString("temp_defect") %></td>
        <td data-title="Released"><%=rs.getString("pressure_defect") %></td>
        <td data-title="Studio"><%=rs.getString("capacity_defect") %></td>
        <td data-title="Studio"><%=rs.getString("expiry_defect") %></td>
        <td data-title="Studio"><%=rs.getString("refilling_defect") %></td>
           <td data-title="Studio"><a href="changecylinder_details.jsp?pid=<%=rs.getString("id")%>">Rectify the defect</a></td>
