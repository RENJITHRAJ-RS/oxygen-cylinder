...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">View Rectify Details</h6>
    </div>
    <div class="contact">
		<div class="container">
     ...
     %>
        ...
        <td data-title="Studio"><%=rs.getString("pressure") %></td>
          ...
          <td data-title="Studio"><%=rs.getString("gas_capacity") %></td>
           ...
           <td data-title="Studio"><a href="rectify_defect2.jsp?pid1=<%=rs.getString("id")%>&&temperature=<%=rs.getString("temperature")%>&&pressure=<%=rs.getString("pressure")%>&&gas_capacity=<%=rs.getString("gas_capacity")%>&&expiring_date=<%=rs.getString("expiring_date")%>&&refilling_date=<%=rs.getString("refilling_date")%>">Check Defects</a></td>
