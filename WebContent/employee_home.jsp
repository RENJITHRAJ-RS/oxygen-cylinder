...
<div class="bgded overlay padtop" style="background-image:url('images/demo/backgrounds/01.jpg');"> 
  ...
  <header id="header" class="hoc clear">
    ...
    <nav id="mainav" class="fl_right"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li class="active"><a href="employee_home.jsp">Upload Cylinder</a></li>
         <li ><a href="view_cylinder.jsp">View Cylinder</a></li>
       
         <li ><a href="eview_pmanagersolution.jsp">Production Manager Solution</a></li>
        <li ><a href="purchase_parts.jsp" >Purchase parts</a></li>
        <li ><a href="purchase_status.jsp" >Product Purchase Status</a></li>
  ...
  <main class="hoc container clear"> 
    ...
    <section id="services">
      ...
      <ul class="nospace group grid-3">
        <li class="one_third">
          <article><a href="#"><i class="fas fa-spray-can"></i></a>dkiiefjkfoihwenflkfiurjjkiflldodfjjffikfikkfpalafkfijse
        ...
        <li class="one_third">vhkfkfoeiuejflkjiieffjkfliiiejfhnekjj
          <article><a href="#"><i class="fas fa-dolly-flatbed"></i></a>
            <h6 class="heading">Vestibulum</h6>kkvfjjehffoofurhfihfinfbuuhfjjdfbbbb
            <p>Pellentesque malesuada sed et nulla sit amet nisi scelerisque consectetuer vivamus odio donec metus libero semper.</p>
            <footer><a href="#">More Details &raquo;</a></footer>jjjfhjjjgdiqudhhaofufidhdufgdhfhjsga
          </article>
        </li>
        <li class="one_third">
    ...
    <div class="contact">
		<div class="container">
			...
			<div class="contact-mian">
				...
				<div class="contact-bottom" style="margin-left:200px;">
				<form action="upload_cylinder.jsp" method="post" enctype="multipart/form-data">
				<table style="width:400px;height:200px;">
				<tr>
				<td>
				<label style="align:left;">Type Of Oxygen Cylinder</label>
				</td>
				<td><input type="text" name="oxygen_type" style="width:250px;align:justify;color:black;"></td>
				</tr>
				
				<tr>
				<td><label style="align:left;">Temperature</label></td>
				<td><input type="text" name="temperature" style="width:250px;align:justify;color:black;"></td>
				</tr>
				
				<tr>
				<td><label style="align:left;">Pressure</label></td>
				<td><input type="text" name="pressure" style="width:250px;align:justify;color:black;"></td>
				</tr>
			
				<tr>
				<td><label style="align:left;">Tube Material</label></td>
				<td><input type="text" name="tube_material" style="width:250px;align:justify;color:black;"></td>
				</tr>
			
				<tr>
				<td><label style="align:left;">Type of Cylinder</label></td>
				<td><input type="text" name="cylinder_type" style="width:250px;align:justify;color:black;"></td>
				</tr>
				<tr>
				<td><label style="align:left;">Gas type</label></td>
				<td><input type="text" name="gas_type" style="width:250px;align:justify;color:black;"></td>
				</tr>
				<tr>
				<td><label style="align:left;">Gas Capacity </label></td>
				<td><input type="text" name="gas_capacity" style="width:250px;align:justify;color:black;"></td>
				</tr>
				<tr>
				<td><label style="align:left;">Expiring date</label></td>
				<td><input type="text" name="expiring_date" style="width:250px;align:justify;color:black;"></td>
				</tr>
				<tr>
				<td><label style="align:left;">Refilling Date</label></td>
				<td><input type="text" name=refilling_date style="width:250px;align:justify;color:black;"></td>
				</tr>
				<tr>
				<td><label style="align:left;">Image</label></td>
				<td><input type="file" name="image" style="width:250px;align:justify;color:black;"></td>
				</tr>
				</table>
				...
				<div class="col-md-4 contact-left">
					<img src="images/images/upload1.png" width="250" height="250">
...
<!-- <div class="wrapper row2">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">Gravida donec non erat eget</h6>jkkifjeioopfipoifkioueyhy<hfuhfjfufu
    </div>
      ...
      <li class="one_third first">
        <article>
          <figure><a class="imgover" href="#"><img src="images/demo/348x261.png" alt=""></a>
            <figcaption>
              <ul class="nospace meta clear">hjhkjerdkkkdisjhjlOUIFJOPSKKFFFUFU
                <li><i class="fas fa-user"></i> <a href="#">Admin</a></li>
                <li>
                  <time datetime="2045-04-06T08:15+00:00">06 Apr 2045</time>
                </li>
              </ul>
              <h6 class="heading"><a href="#">Elit pellentesque dapibus</a></h6>KFUEFJJAHEHFUhiehiwujhddoiiudsjsahok
            </figcaption>
          </figure>
          ...
          <figure><a class="imgover" href="#"><img src="images/demo/348x261.png" alt=""></a>
            <figcaption>
              <ul class="nospace meta clear">
                <li><i class="fas fa-user"></i> <a href="#">Admin</a></li>kfjoe9e8ufjjfhhfjehehjehfee
                <li>
  ...
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_quarter">
      ...
      <form action="#" method="post">
        <fieldset>
          <legend>Newsletter:</legend>jjuhyefgfgjufgfgdjduaidallaojhjfujfkksoujd
