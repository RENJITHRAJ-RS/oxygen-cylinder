...
System.out.println("unid1===="+pid);
 ...
 if(capacity>=10)
 {
	 ...
	 String sql="update upload_cylinder set capacity_defect='"+pstatus+"' where id='"+pid+"'";
 ...
 else
 {
	 ...
	 String sql1="update upload_cylinder set capacity_defect='"+pstatus1+"' where id='"+pid+"'";
	 ...
	 %>
	 <script>
	 alert("No Gas Capacity Defect In Product");
	 window.location="productionmanager_home.jsp";
	 </script>
	 <% 
	 }
