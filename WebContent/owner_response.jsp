...
<div class="bgded overlay padtop" style="background-image:url('images/demo/backgrounds/01.jpg');"> 
  ...
  <header id="header" class="hoc clear">
    <div id="logo" class="fl_left"> 
      <!-- ################################################################################################ -->
      <h1><a href="index.html">office manager</a></h1>
      <!-- ################################################################################################ -->
    </div>
    <nav id="mainav" class="fl_right"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li ><a href="officemanager_home.jsp">View Employee Request</a></li>
         <li class="active"><a href="owner_response.jsp">View Owner Response</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">View Owner Response</h6>
    </div>
   <div class="contact">
		<div class="container">
        ...
        <td data-title="Studio"><%=rs.getString("pmanager_status") %></td>
         <td data-title="Studio"><%=rs.getString("owner_status") %></td>
          <td data-title="Studio"><%=rs.getString("purchase_status") %></td>
            <td data-title="Studio"><a href="buy_product.jsp?pid=<%=rs.getString("id")%>">Buy Product</a></td>
                <td data-title="Studio"><a href="sendto_employee.jsp?pid1=<%=rs.getString("id")%>">Send To Employee</a></td>
