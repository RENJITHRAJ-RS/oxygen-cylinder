...
<div class="bgded overlay padtop" style="background-image:url('images/demo/backgrounds/01.jpg');"> 
  ...
  <header id="header" class="hoc clear">
    ...
    <nav id="mainav" class="fl_right"> 
      <!-- ################################################################################################ -->
       <ul class="clear">
        <li ><a href="employee_home.jsp">Upload Cylinder</a></li>
         <li ><a href="view_cylinder.jsp">View Cylinder</a></li>
       
         <li class="active" ><a href="changecylinder_details.jsp">Production Manager Solution</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">Rectify the defect</h6>
    </div>
    ...
    String sql="select * from upload_cylinder where id='"+pid+"'";
    PreparedStatement ps=con.prepareStatement(sql);
    ResultSet rs=ps.executeQuery();    	
    while(rs.next())
     {%>
				<form action="rectify_defectdb.jsp" method="post" >
				<table style="width:400px;height:200px;">
				
				
				<tr>
				<td><label style="align:left;">Temperature</label></td>
				<td><input type="text" name="temperature" value="<%=rs.getString("temperature")%>"style="width:250px;align:justify;color:black;"></td>
				</tr>
				
				<tr>
				<td><label style="align:left;">Pressure</label></td>
				<td><input type="text" name="pressure" value="<%=rs.getString("pressure")%>" style="width:250px;align:justify;color:black;"></td>
				</tr>
				<tr>
				<td><label style="align:left;">Gas Capacity </label></td>
				<td><input type="text" name="gas_capacity"  value="<%=rs.getString("gas_capacity")%>"style="width:250px;align:justify;color:black;"></td>
				</tr>
				<tr>
				<td><label style="align:left;">Expiring date</label></td>
				<td><input type="text" name="expiring_date" value="<%=rs.getString("expiring_date")%>" style="width:250px;align:justify;color:black;"></td>
				</tr>
				<tr>
				<td><label style="align:left;">Refilling Date</label></td>
				<td><input type="text" name=refilling_date value="<%=rs.getString("refilling_date")%>" style="width:250px;align:justify;color:black;"></td>
				</tr>
