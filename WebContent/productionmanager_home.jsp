...
<div class="bgded overlay padtop" style="background-image:url('images/demo/backgrounds/01.jpg');"> 
  ...
  <header id="header" class="hoc clear">
    <div id="logo" class="fl_left"> 
      <!-- ################################################################################################ -->
      <h1><a href="index.html">Manager</a></h1>
      <!-- ################################################################################################ -->
    </div>
      ...
      <!-- ################################################################################################ -->
       <ul class="clear">
        <li class="active"><a href="employee_home.jsp">View Cylinder</a></li>
         <li ><a href="view_defection.jsp">View Defection</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading">View Employee Report</h6>
    </div>
    <div class="contact">
		<div class="container">
			...
			<div style="width:900px;height:400px;overflow:scroll;margin-left:50px;">
				<table id="customers">
  <tr>
    <th>Oxygen Type</th>
    <th>Temperature</th>
  ...
  <%
    ...
    String sql="select * from upload_cylinder where defect_result='"+defect1+"'";
        ...
        <td data-title="Studio"><%=rs.getString("cylinder_type") %></td>
         <td data-title="Studio"><%=rs.getString("gas_type") %></td>
          <td data-title="Studio"><%=rs.getString("gas_capacity") %></td>
           ...
           <td data-title="Studio"><%=rs.getString("defect_result") %></td>
             <td data-title="Studio"><img src="viewimage.jsp?id=<%=rs.getString("id")%>" width="130" height="120" alt="" class="userpic" /></td>
        <td data-title="Studio"><a href="pmangaer_viewdefect.jsp?unid=<%=rs.getString("id")%>&&temperature=<%=rs.getString("temperature")%>&&pressure=<%=rs.getString("pressure")%>&&gas_capacity=<%=rs.getString("gas_capacity")%>&&expiring_date=<%=rs.getString("expiring_date")%>&&refilling_date=<%=rs.getString("refilling_date")%>">View Defects</a></td>
