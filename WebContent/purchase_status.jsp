  ...
  <header id="header" class="hoc clear">
    ...
    <nav id="mainav" class="fl_right"> 
      ...
      <ul class="clear">
        ...
        <li class="active"><a href="purchase_status.jsp" >Product Purchase Status</a></li>
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');">
  ...
  <%
    ...
    String sql="select * from parts_purchase";
    ...
    while(rs.next())
     ...
     %>
    	<tr>
        <td scope="row"><%=rs.getString("parts_name") %></td>
        <td data-title="Released"><%=rs.getString("quantity") %></td>
        <td data-title="Studio"><%=rs.getString("pmanager_status") %></td>
        <td data-title="Studio"><%=rs.getString("owner_status") %></td>
        <td data-title="Studio"><%=rs.getString("purchase_status") %></td>
            <td data-title="Studio"><a href="purchase_status1.jsp?pid=<%=rs.getString("id")%>">View Product Purchase Status</a></td>
